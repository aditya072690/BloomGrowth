                      ...
                      t.data("et-is-menu-ready") ||
                        (t
                          ...
                          .on("mouseleave", function () {
                            window.et_pb_toggle_nav_menu(n(this), "close", 800);
                          }),
            ...
            (e.getLimitSelector = b),
              ...
              (e.getStickyStyles = function (t, e, n) {
                ...
                var a = function (t) {
                  ...
                  r = e[0].parentNode.classList.contains("et_pb_equal_columns");
                r && (e.hide(), n.hide());
                var s = {
                    ...
                    if (
                      ...
                      return (
                        t(this).parents().hasClass("widget_recent_reviews") &&
                          t(".reviews_tab")
                            .trigger("click")
                            .animate({ scrollTop: p.offset().top }, 700),
