                ...
                (function($, window, document, undefined) {
                    ...
                    $.fn.mainDiviMegaPro = function(options) {
                        var divimegapro_body,
                            ...
                            isIphone,
                            smallDevice,
                            isDiviMenuBarVisible = $('.mobile_menu_bar').is(':visible'),
                            themesBreakpoint = {
                                Divi: 980,
                                Extra: 1024
                            },
                        ...
                        if ($('div.divimegapro-container').length) {
                                ...
                                if ('undefined' !== typeof dClass && 'undefined' !== typeof dURL && 'undefined' !== typeof dTarget) {
                                    ...
                                    if (dURL && dURL.indexOf('#') !== -1) {
                                        ...
                                        if ('#' === dURL[0] && dURL.length && anchorElem.length) {
                                            et_pb_smooth_scroll(anchorElem, !1, 800, "swing"),
                                            setTimeout((function() {
                            ...
                            function createDiviMegaPro(divimegapro_id, selector, dmp_parent_selector, singletonEnabled) {
                                ...
                                setTimeout(function() {
                                    ...
                                    tippyIns = tippy(selector, allProps);
                                    // tippyIns = tippyv5(selector, allProps);
                                    if (tippyIns && singletonEnabled === true && dmp_parent_selector === ''){
                                        tippyIns.disable();
                            ...
                            function initDiviElements(divimegapro_id, singletonEnabled) {
                                ...
                                initDiviElements_timer = setTimeout(function() {
                                    ...
                                    clear_et_tabs_cache($et_pb_tabs),
                            ...
                            function initDiviGearProductCarousel() {
                                ...
                                if (e(tippyRef + ".dgpc_product_carousel").length > 0) {
                                    e(tippyRef + ".dgpc_product_carousel").each(function(t, o) {
                                        ...
                                        e(this).find(".products").addClass("dg-products"),
                                        e(this).find(".products").removeClass("products");
                                        var p = new Swiper(r, {
                                ...
                                if (e(tippyRef + ".dica_divi_carousel").length > 0) {
                                    e(tippyRef + ".dica_divi_carousel").each(function(t, o) {
                                        ...
                                        "on" !== N && j.on("observerUpdate", function(e) {
                                            "on" == u && ((j.autoplay.paused = !1), (j.translate = 0)),
                                            j.update()
                                        }),
                            ...
                            function initCCPWCalculator(dmpRef) {
                                $(dmpRef + ' .divimegapro-body .ccpw_calculator').each(function() {
                                    let pThisCCPW = $(this),
                                        ...
                                        ID,
                                        el = dmpRef + ' .divimegapro-body [data-calc-id="' + pThisCCPW.attr("data-calc-id") + '"]';
                            ...
                            function initDSM_AdvancedTabs(dmpRef) {
                                let e = document.querySelectorAll(dmpRef + ' .dsm-advanced-tabs-container'),
                                    s = s => {
                                        let {tabs: a, index: t, tabsContent: d, animationName: i, innerAnimationName: c, currentTabId: l, deepLink: n, container: r} = s,
                                            o = d[t].querySelector(".dsm-inner-content-wrapper");
                                        d.forEach((e, s) => {
                                            o.classList.remove(`${c}`),
                                            e.classList.remove("dsm-active", `${i}`),
                                            a[s].classList.remove("dsm-active", `${i}`)
                                        }),
                                        e.forEach(e => {
                                            e && e.classList.remove("dsm-active-deep-link")
                                        }),
                                        a[t].classList.add("dsm-active"),
                                        d[t].classList.add("dsm-active", `${i}`),
                                        o.classList.add("animated", c),
                                        n && (location.hash = l, location.hash.substring(1) === l && r.classList.add("dsm-active-deep-link"))
                                    };
                                e.forEach((e, a) => {
                                    ...
                                    t.forEach((a, r) => {
                                        ...
                                        n && "" !== location.hash && m === location.hash.substring(1) && s(h),
                                                    ...
                                                    if (_ = "<ul>", o.removeClass("et_contact_error"), o.each((function() {
                                                        ...
                                                        if ("checkbox" === s) {
                                                            if (o = "", 0 !== e.find('input[type="checkbox"]').length) {
                                                                ...
                                                                e.find('input[type="checked"]:checked') && (o = [], e.find('input[type="checkbox"]:checked').each((function() {
                                                                    o.push(n(this).val())
                                                                })), o = o.join(", "))
                                                            }
                                                    ...
                                                    if (!l) {
                                                        ...
                                                        t.removeClass("et_animated").removeAttr("style").fadeTo("fast", .2, (function() {
                                                            t.load("".concat(v, " #").concat(t.attr("id"), "> *"), m, (function(e, a) {
                                                                ...
                                                                n(e).find(".et_pb_contact_error_text").length || (xt(t, "con_goal"), "" !== i && (window.location.href = i)),
                                                                t.fadeTo("fast", 1)
                                                            }))
                                                        }))
                                                    }
                                                    _ += "</ul>",
                                                    "" !== d && ("<ul></ul>" !== _ && (_ = '<p class="et_normal_padding">'.concat(et_pb_custom.contact_error_message, "</p>").concat(_)), d = "<ul>".concat(d, "</ul>"), d = "<p>".concat(et_pb_custom.fill_message, "</p>").concat(d), _ = d + _),
                                                    "<ul></ul>" !== _ && (s.html(_), t.parents(".et_pb_section_parallax").length && t.parents(".et_pb_section_parallax").each((function() {
